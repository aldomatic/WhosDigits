...
//    }
    ...
    func danger(viewController: UIViewController, title: String, text: String?=nil, buttonText: String?=nil, cancelButtonText: String?=nil) -> JSSAlertViewResponder {
        let alertview = self.show(viewController, title: title, text: text, buttonText: buttonText, cancelButtonText: cancelButtonText, color: UIColorFromHex(0x2e0000, alpha: 1))
        alertview.setTextTheme(.Light)
        return alertview
    }
    
    func showContactAddedConfirmation (viewController: UIViewController) -> JSSAlertViewResponder{
    ...
    func show(viewController: UIViewController, title: String, text: String?=nil, buttonText: String?=nil, cancelButtonText: String?=nil, color: UIColor?=nil, iconImage: UIImage?=nil) -> JSSAlertViewResponder {
        ...
        titleLabel.font = UIFont(name: self.titleFont, size: 18)
        ...
        if let text = text {
            ...
            textView.font = UIFont(name: self.textFont, size: 14)
        ...
        let buttonColor = UIImage.withColor(adjustBrightness(baseColor!, amount: 0.9))
